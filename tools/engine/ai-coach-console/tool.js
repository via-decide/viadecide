...
const STORE_KEY = 'engine.ai-coach-console.draft';
...
function runEngine() {
  ...
  const result = EngineModels.ai_coach_console(metrics, parsed, secondary);

  output.textContent = JSON.stringify({
    tool: 'ai-coach-console',
    purpose: 'coach recommendations',
    mode,
    metrics,
    result,
...
document.getElementById('download').addEventListener('click', () => {
  ...
  a.download = 'ai-coach-console-output.json';
  a.click();
});
