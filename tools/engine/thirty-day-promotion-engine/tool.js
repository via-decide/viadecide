...
const STORE_KEY = 'engine.thirty-day-promotion-engine.draft';
...
function runEngine() {
  ...
  const result = EngineModels.thirty_day_promotion_engine(metrics, parsed, secondary);

  output.textContent = JSON.stringify({
    tool: 'thirty-day-promotion-engine',
    purpose: 'evaluate monthly promotion',
    mode,
    metrics,
    result,
...
document.getElementById('download').addEventListener('click', () => {
  ...
  a.download = 'thirty-day-promotion-engine-output.json';
  a.click();
});
